  ...
  return (
    <div className="flex flex-col items-center py-4 w-full bg-[#272727]">
      ...
      <div className="min-h-[240px] md:min-h-[300px] lg:min-h-[320px] flex items-center justify-center">
        <h1 className="text-4xl md:text-4xl lg:text-6xl font-bold max-w-7xl mx-auto text-center relative z-20 py-6 bg-clip-text text-[#ffffff] dark:from-neutral-800 dark:via-white dark:to-white">
      ...
      <div className="flex relative justify-center items-center gap-2 mt-2 py-4 z-10 min-h-[60px]">
        ...
        <Link href="/#why-choose-us" scroll={true}>
          <Button className="bg-transparent  border text-[#ffffff] border-[#272727] hover:text-[#ffffff] hover:bg-[#272727]">
            Learn More
          </Button>
        </Link>
      </div>
